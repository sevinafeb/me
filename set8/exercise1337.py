...
def set_it_on_fire(input_string="very naughty boy") -> str:
    ...
    """
    str = list(input_string.upper())
    set_it_on_fire = "🔥".join(str)
    final = "🔥" + set_it_on_fire + "🔥"
    return final 
...
def best_letter_for_pets() -> str:
    ...
    for letter in the_alphabet: 
        ...
        num_pets = len(pet_list)
        if num_pets > max_length:
            max_length = num_pets
